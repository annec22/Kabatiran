...
//            var icon = $('<img onclick="" id="' + sFromId + '" class="ui-datepicker-trigger fromDateIcon" src="http://localhost/administratormodule/styles/images/calendar.gif" alt="..." title="..."></img>');
            from.datepicker();
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
